...
##2.## En nuestro caso SQLite es ideal porque no necesitamos servers, si no que se puede usar el almacenamiento local sin necesidad de configuración. SQLite se puede usar más que nada en proyectos chicos como es nuestro caso. 
